...
This term the topic of Visual Analytics Project will be based on [VAST Challenge 2024](https://vast-challenge.github.io/2024/index.html). The are three Mini Challenges and a Grand Challenge provided. Teams are required to choose one of the Challenge and build a Shiny Application to answer the questions of the Challenge.
